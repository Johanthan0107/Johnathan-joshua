...
public class Main {
  ...
  public static void main(String[] args) {
   ...
   //This is inner loop:
      for (int j = 1; j <= 4; j++) {
        System.out.println(" Inner: " + j); // Executes 12 times (3 * 4),How it's displayed:- out put will be start out put 1,out put2,out put3,like this, and input will be start input 1,input 2,input 3,input 4 like this.
